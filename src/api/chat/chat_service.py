...
class ChatService:
    def __init__(self, config: AzureConfig, user_id: str, session_id: str):
        ...
        self.system_prompt = """You are an agent helping developers find API endpoints to build their applications.
                    ...
                    portal_url=https://dev-developer.mercy.net/api-details#api=api=patients-api&operation=sendMessage
                   ...
                   Example:
                    Question:How do I find claim status
                        ...
                        "text" : "Claim status can be found with the endpoint /claims-api/v1/status
                                ...
                                portal_url https://dev-developer.mercy.net/api-details#api=api=claims-api&operation=status
                                ...
                                portal_url: https://dev-developer.mercy.net/api-details#api=api=claims-api&operation=somethingelse"
